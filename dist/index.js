(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.StyledCssGrid = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Grid = exports.Cell = undefined;
...
},{"./lib/Cell":2,"./lib/Grid":3}],2:[function(require,module,exports){
"use strict";
...
var Cell = _react.styled.div(_templateObject, function (_ref) {
  ...
  var area = _ref6.area;
  return area && "grid-area: " + area;
}, /* prettier-ignore */
function (_ref7) {
  var middle = _ref7.middle;
...
},{"linaria/react":15,"prop-types":21}],3:[function(require,module,exports){
"use strict";
...
var autoRows = function autoRows(_ref) {
...
var gap = function gap(_ref2) {
  var _ref2$gap = _ref2.gap,
      gap = _ref2$gap === undefined ? "8px" : _ref2$gap;
  return gap;
};

var flow = function flow(_ref3) {
  var _ref3$flow = _ref3.flow,
      flow = _ref3$flow === undefined ? "row" : _ref3$flow;
  return flow;
};
...
var Grid = _react.styled.div(_templateObject, function (_ref4) {
  var _ref4$height = _ref4.height,
      height = _ref4$height === undefined ? "auto" : _ref4$height;
  return height;
}, flow, autoRows, function (_ref5) {
  var rows = _ref5.rows;
  return rows && "grid-template-rows: " + frGetter(rows);
}, function (_ref6) {
  var _ref6$columns = _ref6.columns,
      columns = _ref6$columns === undefined ? 12 : _ref6$columns;
  return frGetter(columns);
}, gap, function (_ref7) {
  var columnGap = _ref7.columnGap;
  return columnGap && "column-gap: " + columnGap;
}, function (_ref8) {
  var rowGap = _ref8.rowGap;
  return rowGap && "row-gap: " + rowGap;
}, function (_ref9) {
  var areas = _ref9.areas;
  return areas && "grid-template-areas: " + formatAreas(areas);
}, function (_ref10) {
  var justifyContent = _ref10.justifyContent;
  return justifyContent && "justify-content: " + justifyContent;
}, function (_ref11) {
  var alignContent = _ref11.alignContent;
  return alignContent && "align-content: " + alignContent;
});

Grid.propTypes = {
  className: _propTypes2.default.string,
  columns: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  gap: _propTypes2.default.string,
  columnGap: _propTypes2.default.string,
  rowGap: _propTypes2.default.string,
  height: _propTypes2.default.string,
  minRowHeight: _propTypes2.default.string,
  flow: _propTypes2.default.string,
  rows: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  areas: _propTypes2.default.arrayOf(_propTypes2.default.string),
...
},{"linaria/react":15,"prop-types":21}],4:[function(require,module,exports){
'use strict';
...
},{"./emptyFunction":6,"_process":17}],10:[function(require,module,exports){
"use strict";
...
},{"./core/css":10,"./core/cx":11}],13:[function(require,module,exports){
"use strict";

exports.styled = require('./styled');

},{"./styled":14}],14:[function(require,module,exports){
(function (process){
"use strict";
...
},{"../index":12,"@emotion/is-prop-valid":4,"_process":17,"react":25}],15:[function(require,module,exports){
/* eslint-disable import/no-unresolved */

module.exports = require('./lib/react');

},{"./lib/react":13}],16:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":22,"_process":17,"fbjs/lib/invariant":8,"fbjs/lib/warning":9}],19:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./lib/ReactPropTypesSecret":22,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":8}],20:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./checkPropTypes":18,"./lib/ReactPropTypesSecret":22,"_process":17,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":8,"fbjs/lib/warning":9}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"_process":17,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":8,"fbjs/lib/warning":9,"object-assign":16,"prop-types/checkPropTypes":18}],24:[function(require,module,exports){
...
},{"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":8,"object-assign":16}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":23,"./cjs/react.production.min.js":24,"_process":17}]},{},[1])(1)
});